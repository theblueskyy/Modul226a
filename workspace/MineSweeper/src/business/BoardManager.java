...
public class BoardManager 
{
    ...
    GameDatails mDatails;
    BooleanProperty mLose = new SimpleBooleanProperty();
    IntegerProperty mEmpty = new SimpleIntegerProperty();
    BooleanProperty mWin = new SimpleBooleanProperty(false);
    ...
    List<TilesManager> getNextSquare(TilesManager pTilesManager) 
    {
    ...
    int getMinesAround(TilesManager pTilesManager) 
    {
        int col = pTilesManager.getCol();
        int row = pTilesManager.getRow();
