...
public class Interface 
{
    ...
    BorderPane mGame = new BorderPane();
    MenuPane mMenu = new MenuPane();
    Pane mPane = new StackPane();
    GameBoard mGameBoard;
    DoubleProperty mWidth = new SimpleDoubleProperty(this, "width", 0);
    DoubleProperty mHeight = new SimpleDoubleProperty(this, "height", 0);

    BoardManager mBoardManager;
    GameDatails mGameDatails = GameDatails.GAME;
    Scene mScene;
